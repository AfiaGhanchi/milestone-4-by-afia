(_a = document.getElementById('r-form')) === null || _a === void 0 ? void 0 : _a.addEventListener('submit', function (event) {
    ...
    if (proPicInput && nameElement && emailElement && contactElement && experienceElement && educationElement && skillsElement) {
        ...
        // Create resume output with contenteditable attribute
        var resume = "<h3>Resume</h3>\n        ".concat(proPicUrl ? "<img src=\"".concat(proPicUrl, "\" alt=\"Profile Image\" class=\"pro-pic\" id=\"resume-pic\">") : '', "\n        <p contenteditable=\"true\"><strong>Name:</strong> ").concat(name_1, "</p>\n        <p contenteditable=\"true\"><strong>Email Address:</strong> ").concat(email, "</p>\n        <p contenteditable=\"true\"><strong>Contact:</strong> ").concat(contact, "</p>\n        <h3>Experience:</h3> <p contenteditable=\"true\">").concat(experience, "</p>\n        <h3>Education:</h3> <p contenteditable=\"true\">").concat(education, "</p>\n        <h3>Skills:</h3> <p contenteditable=\"true\">").concat(skills, "</p>");
